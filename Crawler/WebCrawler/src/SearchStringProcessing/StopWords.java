...
* the space overhead associated with regular d-way tries.
* 
...
public class StopWords {
    ...
    */
	public String RemoveStopWordsString(ArrayList<String> searchWordsList)
	{
		...
		//Remove stop words
		finalSearchStringList = RemoveStopWords(searchWordsList);		
		//Join the list of stop-words in a single string
		finalSearchString = String.join(" ", finalSearchStringList);
